...
<script>
    ...
    var SCOPE = {
        'add_url' : '/NewsWeb/admin.php?c=menu&a=add',
        'edit_url' : '/NewsWeb/admin.php?c=menu&a=edit',
        'set_status_url' : '/NewsWeb/admin.php?c=menu&a=setStatus',
        'listorder_url' : '/NewsWeb/admin.php?c=menu&a=listorder',
    }
</script>
