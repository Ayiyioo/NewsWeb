...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
  ...
  <div class="navbar-header">
    ...
    <a class="navbar-brand">仲园新闻中心管理平台</a>
  </div>
  <!-- Top Menu Items -->
  <ul class="nav navbar-right top-nav">
    ...
    <li class="dropdown">
      ...
      <ul class="dropdown-menu">
        <li>
          <a href="/NewsWeb/admin.php?c=admin&a=personal"><i class="fa fa-fw fa-user"></i> 个人中心</a>
        </li>
       
        <li class="divider"></li>
        <li>
          <a href="/NewsWeb/admin.php?c=login&a=loginout"><i class="fa fa-fw fa-power-off"></i> 退出</a>
        </li>
      </ul>
    </li>
  </ul>
  ...
  <div class="collapse navbar-collapse navbar-ex1-collapse">
    <ul class="nav navbar-nav side-nav nav_list">
      <li <?php echo (getActive($index)); ?>>
        <a href="/NewsWeb/admin.php"><i class="fa fa-fw fa-dashboard"></i> 首页</a>
      </li>
    ...
    <div class="container-fluid" >
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            <li>
              <i class="fa fa-dashboard"></i>  <a href="/NewsWeb/admin.php?c=content">文章管理</a>
            </li>
            <li class="active">
      ...
      <div class="row">
        <form action="/NewsWeb/admin.php" method="get">
          <div class="col-md-3">
              ...
              <table class="table table-bordered table-hover singcms-table">
                ...
                <?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><span class="sing_cursor glyphicon glyphicon-edit" aria-hidden="true" id="singcms-edit" attr-id="<?php echo ($new["news_id"]); ?>" ></span>
                      ...
                      <a target="_blank" href="/NewsWeb/index.php?c=detail&a=view&id=<?php echo ($new["news_id"]); ?>" class="sing_cursor glyphicon glyphicon-eye-open" aria-hidden="true"  ></a>
...
<script>
  var SCOPE = {
    'edit_url' : '/NewsWeb/admin.php?c=content&a=edit',
    'add_url' : '/NewsWeb/admin.php?c=content&a=add',
    'set_status_url' : '/NewsWeb/admin.php?c=content&a=setStatus',
    'sing_news_view_url' : '/NewsWeb/index.php?c=view',
    'listorder_url' : '/NewsWeb/admin.php?c=content&a=listorder',
    'push_url' : '/NewsWeb/admin.php?c=content&a=push',
  }
</script>
