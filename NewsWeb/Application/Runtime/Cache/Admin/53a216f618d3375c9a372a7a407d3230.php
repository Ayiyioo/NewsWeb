		...
		<div class="row">
			<div class="col-lg-6">
				...
				<form class="form-horizontal" id="singcms-form">
					...
					<div class="form-group">
						<label  class="col-sm-2 control-label">系统身份:</label>
						<div class="col-sm-5">
							<input type="text" class="form-control" name="realname" id="inputPassword3" placeholder="" value="<?php echo ($vo["identity"]); ?>">
						</div>
					</div>
...
<script>
	var SCOPE = {
		'save_url' : '/NewsWeb/admin.php?c=admin&a=save',
		'jump_url' : '',
