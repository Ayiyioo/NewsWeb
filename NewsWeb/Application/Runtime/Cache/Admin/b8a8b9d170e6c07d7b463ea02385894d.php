...
<script>
    var SCOPE = {
        'edit_url' : '/NewsWeb/admin.php?c=positioncontent&a=edit',
        'set_status_url' : '/NewsWeb/admin.php?c=positioncontent&a=setStatus',
        'add_url' : '/NewsWeb/admin.php?c=positioncontent&a=add',
        'listorder_url' : '/NewsWeb/admin.php?c=positioncontent&a=listorder',
    }
