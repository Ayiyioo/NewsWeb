...
<script>
  var SCOPE = {
    'save_url' : '/NewsWeb/admin.php?c=content&a=add',
    'jump_url' : '/NewsWeb/admin.php?c=content',
    'ajax_upload_image_url' : '/NewsWeb/admin.php?c=image&a=ajaxuploadimage',
...
<script>
  ...
  KindEditor.ready(function(K) {
    window.editor = K.create('#editor_singcms',{
      uploadJson : '/NewsWeb/admin.php?c=image&a=kindupload',
